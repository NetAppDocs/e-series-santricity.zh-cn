...
NOTE: EF80、EF50、EF600/EF600C 和 EF300/EF300C 存储阵列不支持同步镜像或精简卷。
...
Unified Manager 是基于 Web 的软件，用于管理整个域。从中央视图中，您可以查看所有较新 E-Series 和 EF-Series 阵列的状态，例如 EF80、EF50、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C 和 EF600C。您还可以在选定的存储阵列上执行批处理操作。
