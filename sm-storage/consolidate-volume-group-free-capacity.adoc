...
* 您还可以从池和卷组页面启动 Consolidate Free Capacity 对话框，如以下任务中所述。
...
. 单击菜单：省略号图标 [Consolidate volume group free capacity]。
+
此时将显示整合可用容量对话框。
...
.完成后
选择菜单：Storage[Operations in Progress] 以查看 Consolidate Free Capacity 操作的进度。此操作可能很长，并可能影响系统性能。
